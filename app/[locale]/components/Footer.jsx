          ...
          <div className="row justify-content-between">
            ...
            <div className="col-lg-3 col-md-6">
              ...
              <div className="footer-links">
                <h3>{t('t159')}</h3>
                <ul>
                  <li><a href="#obesity_surgeries">{t('t160')}</a></li>
                  <li>
                    <a href="#obesity_surgeries">{t('t161')}</a>
                  </li>
                  <li><a href="#obesity_surgeries">{t('t162')}</a></li>
                </ul>
              </div>
              {/*  Footer Links End  */}
            </div>
