window.initThemePlugins = function ($) {
  ...
  if (!window.themeEventsBound) {
    window.themeEventsBound = true;
...
$(document).ready(function () {
  const translations = {
    en: {
      ...
      description:
        "BMI is calculated using your weight and height (weight divided by height squared). Along with other factors such as blood pressure and cholesterol, BMI can help estimate the risk of heart disease or stroke.",
    ...
    ar: {
      ...
      description:
        "يتم حساب مؤشر كتلة الجسم باستخدام وزنك وطولك (وزنك مقسوماً على طولك مربعاً)، جنباً إلى جنب مع العديد من العوامل الأخرى مثل ضغط الدم والكوليسترول، ويمكن أن يساعد مؤشر كتلة الجسم في تقدير خطر الإصابة بنوبة قلبية أو سكتة دماغية.",
  ...
  $(".fa-xmark").off("click").on("click", resetLayout);
  $(document)
    .off("click.bmilayout")
    .on("click.bmilayout", function (e) {
      if (
        $(".layout").is(":visible") &&
        !$(".result").is(e.target) &&
